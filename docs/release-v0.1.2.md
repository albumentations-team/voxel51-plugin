...
[Watch the COCO workflow demos](https://github.com/albumentations-team/voxel51-plugin/tree/dev/docs/media).
...
- Keep editable settings across preview, validation errors, and result navigation.
  Returning drafts initialize nested text fields before the App mounts them; closing
  results releases the toolbar instead of leaving an invisible output overlay.
